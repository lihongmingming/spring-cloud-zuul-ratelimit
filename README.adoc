...
[NOTE]
====
只需将多个配置段添加到列表中，就可以组合经过身份验证的用户，请求源，URL，ROLE和请求方法的方式进行限流。
====
...
[NOTE]
====
Latest version: image:https://maven-badges.herokuapp.com/maven-central/com.marcosbarbero.cloud/spring-cloud-zuul-ratelimit/badge.svg["Maven Central", link="https://github.com/lihongmingming/spring-cloud-zuul-ratelimit/releases/tag/6.2.2-SNAPSHOT"]
====
